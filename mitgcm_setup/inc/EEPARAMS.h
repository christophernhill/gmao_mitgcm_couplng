...
C     Real-type constant for some frequently used simple number (0,1,2,1/2):
      ...
      PARAMETER ( zeroRS = 0.0 D 0 , oneRS  = 1.0 D 0 )
      PARAMETER ( twoRS  = 2.0 D 0 , halfRS = 0.5 D 0 )
      _RL     zeroRL, oneRL, twoRL, halfRL
      PARAMETER ( zeroRL = 0.0 D 0 , oneRL  = 1.0 D 0 )
      PARAMETER ( twoRL  = 2.0 D 0 , halfRL = 0.5 D 0 )
