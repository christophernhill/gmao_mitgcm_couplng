...
setenv SITE             NAS
setenv GEOSDIR          /nobackupp11/dmenemen/DYAMOND/c90_llc90_05/GEOSodas 
setenv GEOSBIN          /nobackupp11/dmenemen/DYAMOND/c90_llc90_05/GEOSodas/Linux/bin 
...
setenv    EXPID   TEST
setenv    EXPDIR  /nobackupp11/dmenemen/DYAMOND/c90_llc90_05/TEST
setenv    HOMDIR  /nobackupp11/dmenemen/DYAMOND/c90_llc90_05/TEST
...
/bin/ln -sf $GRIDDIR/${BCRSLV1}-Runoff.bin runoff.bin
/bin/ln -sf $GRIDDIR/mit-llc90_15x15.ascii .
...
set H_NPX = `echo 360 | awk '{printf "%5.5i", $1}'`
set H_NPY = `echo 181 | awk '{printf "%5.5i", $1}'`
...
if( $FSEGMENT != 00000000 ) then
     ...
     if( $nymdz >= ${REPLAY_BEG_DATE} & \
         ...
         qsub $EXPDIR/forecasts/gcm_forecast.j${nymdz}-${nymdz}
     endif
endif
...
#      if ( $capdate == $enddate & $captime < $endtime ) qsub $HOMDIR/gcm_run.j
